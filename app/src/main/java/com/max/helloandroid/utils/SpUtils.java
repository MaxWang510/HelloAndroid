...
public class SpUtils {
    private static final String spFileName = "HelloAndroid";
    ...
    public static void putFolat(Context context, String strKey, Float strData) {
        SharedPreferences activityPreferences = context.getSharedPreferences(
                spFileName, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = activityPreferences.edit();
    ...
    public static void clean(Context context, String strKey) {
        SharedPreferences setPreferences = context.getSharedPreferences(
                spFileName, Context.MODE_PRIVATE);
    ...
    public static void cleanSpUtilData(Context context) {
        SharedPreferences setPreferences = context.getSharedPreferences(
                spFileName, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = setPreferences.edit();
        editor.clear();
